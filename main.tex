...
\end{figure}
      \begin{figure} [H]
    \includegraphics[width=1.0\textwidth]{img/stretch_sensors}
    \caption{The different sizes of stretch sensors we tested (missing 1.0x5.0cm)}
\end{figure}
      \begin{figure} [H]
    \includegraphics[width=1.0\textwidth]{img/stretch_test_setup}
...
\marginpar{%
  \vspace{-110pt} \fbox{%
    ...
    \textbf{Pressure sensor evaluation} \\
      \begin{figure} [H]
   \centering \includegraphics[width=0.85\textwidth]{img/pressure_sensor.jpg}
    \caption{The prototyping of the eTextile pad.}
\end{figure}
      \begin{figure} [H]
   \centering \includegraphics[width=0.85\textwidth]{img/pressure_sensor2.JPG}
    \caption{Overview of the final pressure sensor construction (materials and assembly).}
\end{figure}
      \begin{figure} [H]
   \centering \includegraphics[width=0.85\textwidth]{img/pe_integration.JPG}
